...
const SvgComponent = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6000 276.04" {...props}>
    <defs>
      <style>
        {
          ".cls-1{fill:#4c4c4c}.cls-4{fill:#fff}.cls-5{fill:#8bc53f}.cls-7{fill:#58595b}"
        }
      </style>
    </defs>
    <title>{"coingecko_full vector"}</title>
